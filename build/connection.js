...
const client = new whatsapp_web_js_1.Client({
    authStrategy: new whatsapp_web_js_1.LocalAuth({
        dataPath: path_1.default.resolve(__dirname, '..', 'whatsapp_web', 'auth_info_multi.json')
    })
});
const connect = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    client.on('ready', () => __awaiter(void 0, void 0, void 0, function* () {
        console.log(yield client.sendPresenceAvailable(), yield client.sendPresenceUnavailable());
        socket.getLabels = client.getLabels(); // или могли бы передать через EventEmitter, но в таком случае это не было бы передачей параметра
    }));
    yield client.initialize(); // ждём пока иницилизируется для продолжения
